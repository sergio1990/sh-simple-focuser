...
; Generated by Serhii Herniak on 3/14/2023 (UTC)
;
[Setup]
...
OutputDir="."
OutputBaseFilename="SHSimpleFocuser Setup"
Compression=lzma
...
UninstallFilesDir="{commoncf}\ASCOM\Uninstall\Focuser\SHSimpleFocuser"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{commoncf}\ASCOM\Uninstall\Focuser\SHSimpleFocuser"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SHSimpleFocuser.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SHSimpleFocuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SHSimpleFocuser.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SHSimpleFocuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SHSimpleFocuser.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
